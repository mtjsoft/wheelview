...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	public enum Type {
		ALL, YEAR_MONTH_DAY, YEAR_MONTH, HOURS_MINS, MONTH_DAY_HOUR_MIN
	...
	public TimePopupWindow(Context context, Type type, String hint) {
		super(context);
	...
	public void onClick(View v) {
		...
		if (tag.equals(TAG_CANCEL)) {
			...
			if (timeSelectListener != null) {
				try {
					Log.i("yuanchen", "time is:" + wheelTime.getTime());
