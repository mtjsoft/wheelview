...
public class WheelView extends View
{
    ...
    {
        // itemsPaint.set
        int width = getWidth() == 0 ? getMeasuredWidth() : getWidth();
        Log.i("chenyuan", "getWidth==" + getWidth() + ",measurewidth===="
                + width + ",widthItem==" + widthItems);
        // || itemsLayout.getWidth() > widthItems
        if (itemsLayout == null)
        {
            itemsLayout = new StaticLayout(buildText(isScrollingPerformed),
                    itemsPaint, width - widthLabel < 0 ? widthItems : width
                            - widthLabel,
                    widthLabel > 0 ? Layout.Alignment.ALIGN_NORMAL
                            : Layout.Alignment.ALIGN_NORMAL, 1,
                    ADDITIONAL_ITEM_HEIGHT, false);
        } /*else {
          itemsLayout.increaseWidthTo(getWidth()-widthLabel<0?widthItems:getWidth()-widthLabel);
          }*/
        ...
        if (valueLayout == null)
        {
            ...
            valueLayout = new StaticLayout(text != null ? text : "",
                    valuePaint, width - widthLabel < 0 ? widthItems : width
                            - widthLabel,
                    widthLabel > 0 ? Layout.Alignment.ALIGN_NORMAL
                            : Layout.Alignment.ALIGN_NORMAL, 1,
                    ADDITIONAL_ITEM_HEIGHT, false);
          ...
          valueLayout = null;
             ...
             valueLayout.increaseWidthTo(getWidth()-widthLabel<0?widthItems:getWidth()-widthLabel);
             }*/

        // if (widthLabel > 0) {
        // || labelLayout.getWidth() > widthLabel
        if (labelLayout == null)
        {
            labelLayout = new StaticLayout(label, valuePaint, widthLabel,
                    Layout.Alignment.ALIGN_NORMAL, 1, ADDITIONAL_ITEM_HEIGHT,
                    false);
        } /*else {
    ...
    private void drawValue(Canvas canvas)
    {
        ...
        Log.i("yuanchen", "value===" + valueLayout.getWidth() + ",item==="
                + itemsLayout.getWidth());
        if (labelLayout != null)
        {
            canvas.save();
            canvas.translate(getMeasuredWidth() - labelWidth - LABEL_OFFSET / 2
                    - 3, bounds.top);
    ...
    private void drawItems(Canvas canvas)
    {
        ...
        // Log.i("yuanchen", "width is:"+width+","+itemsLayout.getHeight());
        // itemsLayout.increaseWidthTo(getWidth());
        int width = itemsLayout.getWidth();
        Log.i("yuanchen", "width is:" + width + "," + itemsLayout.getHeight());
        // itemsLayout.
